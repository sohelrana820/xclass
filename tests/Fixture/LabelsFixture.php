...
class LabelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'color_code' => ['type' => 'string', 'length' => 16, 'null' => true, 'default' => 'eeeeee', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'color_code' => 'Lorem ipsum do',
            'created_by' => 1,
            'created' => '2016-08-05 22:07:00',
            'modified' => '2016-08-05 22:07:00'
        ],
    ];
}
