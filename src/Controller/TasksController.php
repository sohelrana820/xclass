...
class TasksController extends AppController
{
    ...
    public function initialize()
    {
        ...
        $this->projectId = $this->Projects->getProjectIDBySlug($this->request->session()->read('project_slug'));
    }
    ...
    public function index()
    {
        ...
        if(isset($this->projectId) && $this->projectId){
            $conditions = array_merge($conditions, ['Tasks.project_id' => $this->projectId]);
        }
