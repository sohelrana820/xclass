...
<table cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="width: 100%;height: auto;padding-top: 15px;text-align: center;background: #FFF;border-bottom: 1px dashed #DDD;">
            <p style="font-size: 18px;font-family: Georgia, 'Times New Roman', Times, serif;">Cake 3 User Management
            </p>
        </td>
    </tr>
    <!--/HEADER-->
    <!--CONTENT-->
    <tr>
        <td valign="top" style="width: 100%;padding: 20px 50px; text-align: center;">
            <p style="color: #3E4651;font-weight: normal;font-size: 14px; text-align: center;">
                Dear X, <br/>
                Your account has been created successfully. Please click this button below to verify your account
            </p>
        </td>
    </tr>
    <!--/CONTENT-->
